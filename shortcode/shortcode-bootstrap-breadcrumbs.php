 ...
 *
 * Generates breadcrumbs based on the page's parent pages
 *
 * @package	 ABS
 * @since    1.0.0
 */

if ( ! function_exists( 'bootstrap_breadcrumb_shortcode' ) ) {
	// Add the action.
	add_action( 'plugins_loaded', function() {
		// Add the shortcode.
		add_shortcode( 'bs4-breadcrumb', 'bootstrap_breadcrumb_shortcode' );
	});
	...
	function bootstrap_breadcrumb_shortcode() {
		global $post;
